...
public class TopicSelectionPanel extends JPanel {
	...
	public TopicSelectionPanel() {
		...
		myRadioBtn TemaPsicologia = new myRadioBtn("Psicologia", new Color(255, 0, 128), 14);
		...
		myRadioBtn TemaGeologia = new myRadioBtn("Geologia", new Color(180, 100, 40), 14);
		buttonGroup.add(TemaGeologia);
		add(TemaGeologia, "cell 0 3,alignx left,aligny center");

		myRadioBtn TemaAstrologia = new myRadioBtn("Astrologia", new Color(30, 30, 120), 14);
		buttonGroup.add(TemaAstrologia);
		add(TemaAstrologia, "cell 1 3,alignx left,aligny center");

		myRadioBtn TemaAltro = new myRadioBtn("Altro", new Color(140, 141, 142), 14);
