...
public class NorthPanel extends JPanel {
	...
	public NorthPanel() {
		...
		CentrPanel.setLayout(new MigLayout("wrap, fill", "[]", "[][][]"));
			...
			DescrizionePrimaParteLbl.setFont(t.myFont(16));
			...
			DescrizioneSecondaParteLbl.setFont(t.myFont(16));
