	...
	public LogInFrame(Controller c) {
		...
		setContentPane(MainPanel);
			...
			MainPanel.add(CentrPanel, BorderLayout.CENTER);
					...
					UsernameEmailLbl.setFont(t.myFont(16));
					...
					PasswordFld.setFont(t.myFont(16));
					PasswordFld.setColumns(18);
				...
				SouthPanel.setLayout(new BorderLayout(0, 0));
					...
					SouthPanel.add(ActionPanel, BorderLayout.CENTER);
						...
						AnnullaLogInBtn.setPreferredSize(new Dimension(102, 25));
						...
						ConfermaLogInBtn.setPreferredSize(new Dimension(102, 25));
					...
					goToSignUpBtnContainer.setPreferredSize(new Dimension(10, 42));
