...
public class BachecaFrame extends JFrame {
	...
	public BachecaFrame(String Titolo, Controller c) {
...
//__________________________________________________________________Pannello Nord
		...
		MainPanel.add(NorthPanel, BorderLayout.NORTH);
			...
			ProposteLbl1.setFont(new Font("Calibri Light", Font.PLAIN, 26));
...
//__________________________________________________________________Pannello Centrale
		...
		CentrPanel.setLayout(new BorderLayout(0, 0));
			...
			InfoPanel.setPreferredSize(new Dimension(10, 285));
...
//__________________________________________________________________Pannello Nord
	...
	public boolean fieldsAreEmpty() {
		...
		if (getNomeConf().isEmpty() || getDescrizioneConf().isEmpty() || buttonGroup.getSelection().getActionCommand().isEmpty()) {
