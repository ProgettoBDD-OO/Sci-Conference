...
public class GestioneConfFrame extends JFrame {
	...
	public GestioneConfFrame(String Titolo, Controller c) {
				...
				SouthPanel.setLayout(new MigLayout("wrap, fill", "[][]", "[]"));
					...
					AnnullaBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							...
							if (comingFrom.equals("MainFrame")) { controller.backFromAggiuntaConf(); }
							
							else {  }//controller.backFromUpdateConf(); }
						}
					});
					...
					ConfermaBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							controller.goToAggiuntaConf2();
							//controller.goToModificaFrame2();
						}
					});
	}
	...
	public boolean fieldsAreEmpty() {
		...
		if (isEmpty(getNomeTxt(), "Nome") || isEmpty(getDescrizioneTxt(), "Descrizione") || isEmpty(getSedeTxt(), "Sede") 
		|| getDataInizio().isEmpty() || getDataFine().isEmpty() || buttonGroup.getSelection() == null) {
			return true;	
