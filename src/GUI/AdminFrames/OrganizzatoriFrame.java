...
public class OrganizzatoriFrame extends JDialog {
	...
	public OrganizzatoriFrame(ControllerLink contrLink) {
		...
		NomeFld.setText("Nome e cognome");
		NomeFld.setFont(t.myFont(14));
		panel.add(NomeFld, "cell 0 0,growx,aligny center");
		...
		panel.add(TitoloFld, "cell 0 2,growx,aligny center");
		...
		panel.add(AfferenzaFld, "cell 0 3,growx,aligny center");
