...
public class ConferenzaFrame extends JFrame {
	...
	private SessionePanel sessionePanel;
	...
	public ConferenzaFrame(String Titolo, ControllerLink contrLink, Controller contr) {
		...
		setContentPane(MainPanel);
			...
			CentrPanel.setLayout(new BorderLayout(0, 0));
				...
				sessionePanel = new SessionePanel(currentSession, controller);
			...
			MainPanel.add(SouthPanel, BorderLayout.SOUTH);
					...
					IndietroBtn.addActionListener(new ActionListener() {
						public void actionPerformed(ActionEvent e) {
							controllerLink.backFromConferenza(framePrecedente);
						}
					});
					...
					IscrizioneCardPanel.add(RimuoviBtnConteiner, "3");
	...
	public void setId(String idConferenza) { IdConferenza = idConferenza; }
