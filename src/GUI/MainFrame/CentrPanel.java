...
public class CentrPanel extends JPanel{
	...
	public CentrPanel() {
		...
		LogoPanel.setPreferredSize(new Dimension(10, 130));
		LogoPanel.setLayout(new MigLayout("wrap, fill", "[]", "[]"));
		add(LogoPanel, BorderLayout.NORTH);


			JLabel LogoContainer = new JLabel("");
			LogoContainer.setBounds(new Rectangle(0, 0, 400, 110));
		...
		add(UserConfPanel, BorderLayout.CENTER);
			...
			CentrCardPanel.setLayout(CentrCardLayout);
				...
				BeforeAccess.setLayout(new BorderLayout(0, 0));
					...
					JLabel AccediRegistratiLbl = new JLabel("Accedi o Registrati per iscriverti ad una conferenza o visualizzare quelle a cui partecipi.");
					AccediRegistratiLbl.setForeground(t.altGray);
					AccediRegistratiLbl.setFont(t.myFont(18));
					...
					AccediRegistratiPanel.setPreferredSize(new Dimension(10, 215));
					...
					BeforeAccess.add(AccediRegistratiPanel, BorderLayout.SOUTH);
						...
						OLbl.setFont(new Font("Calibri Light", Font.PLAIN, 18));
						...
						RegistratiBtn.setFont(t.myFont(18));
				...
				AdminPanel.setLayout(new MigLayout("wrap, fill", "[][][]", "[]"));
					...
					AggiungiConfBtn.setFont(t.myFont(18));
					...
					ModifcaConfBtn.setFont(t.myFont(18));
					...
					RimuoviConfBtn.setFont(t.myFont(18));
