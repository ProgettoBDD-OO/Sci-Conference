...
public class EastPanel extends JPanel {
	...
	public EastPanel(Controller c) {
		...
		ResearchPanel.setLayout(new BorderLayout(0, 0));
			...
			ResearchContainer.setPreferredSize(new Dimension(10, 50));
			...
			ClearFltrContainer.setPreferredSize(new Dimension(10, 30));
			...
			BachecaPanel.setLayout(new MigLayout("wrap, fill", "[grow]", "[::100px][][::100px]"));
				...
				ConfBachecaPanel.setPreferredSize(new Dimension(300, 150));
