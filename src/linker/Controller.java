...
//+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
	...
	public void addSessioneInfo(String idSessione, SessionePanel sessionePanel) {
		...
		sessionePanel.setDataOraInizio(t.toDateTimeFormat(sessione.getDataOraInizio().getTime()));
		sessionePanel.setDataOraFine(t.toDateTimeFormat(sessione.getDataOraFine().getTime()));
...
//+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+	
	...
	public void goToPartecipanti(String idIntervento) {
		
		ViewPartecipante = new PartecipanteDialog(idIntervento, this);
...
//+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+
    ...
    public void addModSessioneInfo(int currentSession, ModSessioniPanel sessionePanel) {
		...
		ArrayList<Sessione> sessioni = sessioneDAO.getSessioni("");
	...
	public void addModInterventi(String sessione, ModSessioniPanel sessionePanel) {
