...
public class PanelSlide extends JPanel {
    ...
    public PanelSlide() {
        ...
        setLayout(layout);
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 10, Short.MAX_VALUE));
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING).addGap(0, 10, Short.MAX_VALUE));
    ...
    private void animate() {
        ...
        if (animateType == AnimateType.TO_RIGHT) {
            ...
            if (incomingCom.getLocation().x < 0) {
                ...
                incomingCom.setLocation(incomingCom.getLocation().x + animate, 0);
                outgoingCom.setLocation(outgoingCom.getLocation().x + animate, 0);
