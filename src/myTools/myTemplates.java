...
public class myTemplates {
	...
	public String dateFormat(Date date) { return dateFormat.format(date); }


	private SimpleDateFormat monthYearFormat = new SimpleDateFormat("MMMM - yyyy");

	public String monthYearFormat(Date date) { return monthYearFormat.format(date); }


	private SimpleDateFormat timeFormat = new SimpleDateFormat("HH:mm");

	public String timeFormat(Date date) { return timeFormat.format(date); }

	private SimpleDateFormat sqlFormat = new SimpleDateFormat("YYYY-MM-dd");

	public String sqlFormat(Calendar calendar) { return sqlFormat.format(calendar.getTime()); }
}