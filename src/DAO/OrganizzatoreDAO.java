...
public class OrganizzatoreDAO {
    ...
    public void insertOrganizzatore(Organizzatore organizzatore, int idConferenza) {
        ...
        try {
        	...
        	String insert = "CALL insert_organizzatore('" + organizzatore.getEmail() + "', '" + organizzatore.getTitolo() + "', '"
        	+ organizzatore.getNome() + "', '" + organizzatore.getCognome() + "', '" + organizzatore.getAfferenza()+"'," + idConferenza + ");";
