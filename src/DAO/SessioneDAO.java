...
public class SessioneDAO {
	...
	public void updateSessione(Sessione sessione) {
		...
		+ "SET data_ora_inizio = '"+ sessione.getDataOraInizio() +"', data_ora_fine = '"+ sessione.getDataOraFine() +"', coordinatore = '"+ sessione.getCoordinatore() +"', keynote_speaker = '"+ sessione.getKeynoteSpeaker() +"'"
