...
public class TimeComboBox extends JPanel {
	...
	public TimeComboBox() {
		...
		HourComboBox = new JComboBox<String>(Ore);
		add(HourComboBox);
		...
		MinuteComboBox = new JComboBox<Integer>(Minuti);
		add(MinuteComboBox);
	...
	public String gethhmm() {
		...
		if (hh.isEmpty() || hh.equals("hh") || mm.toString().isEmpty() || mm.equals("mm")) { return ""; }
